        ...
        <div className="max-w-[46rem]">
          ...
          <Reveal delay={170}>
            <p className="mt-6 max-w-[46ch] text-lg leading-relaxed text-muted-foreground">
              Build your professional presence on
              Kaarox, present what you offer and make
              it easier for the right people to find
              and contact you.
            </p>
          </Reveal>
        </div>
          ...
          <div className="max-w-[42rem]">
            ...
            <Reveal delay={120}>
              <p
                ...
                "
              >
                Kaarox isn’t only about finding a
                provider. Posts, hubs, messaging and
                shared interests give people more ways
                to connect around what matters to them.
              </p>
            </Reveal>
          </div>
...
const MONTAGE = [
...

  {
    ...
    label:
      'Sports, coaching & racquet activities',
    shortLabel: 'SPORT',
  },
] as const;
        ...
        <div className="relative z-40 max-w-[47rem]">
          ...
          <Reveal delay={130}>
            <p
              ...
              "
            >
              From local and outdoor services to
              hospitality, automotive specialists,
              events, recreation and sports, Kaarox
              helps people discover relevant providers,
              activities and opportunities through one
      ...
      <div className="relative isolate overflow-hidden">
        ...
        <div
          ...
          className="
            absolute
            inset-0
            bg-[radial-gradient(70%_60%_at_50%_50%,hsl(120_10%_4%/0.72),hsl(120_10%_4%/0.96))]
          "
        />
        ...
        >
          ...
          <Reveal delay={130}>
            <p
              ...
              "
            >
              Technology should make connection easier,
              not more complicated. Kaarox brings
              discovery, professional identity and
              communication together in one experience.
            </p>
          </Reveal>
